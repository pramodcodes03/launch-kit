    ...
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
              Ship your SaaS faster with the most complete landing page theme.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500 dark:text-gray-500">&copy; 2025 LaunchKit. All rights reserved.</p>
          <p className="text-sm text-gray-500 dark:text-gray-500">Made with ♥ for builders</p>
        </div>
      </div>
    </footer>
  );
